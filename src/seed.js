...
async function seed() {
    ...
    const ventas = [
        {
            ...
            fecha: new Date("2025-10-13T15:00:00Z"),
            ...
            fecha: new Date("2025-10-13T16:30:00Z"),
            ...
            fecha: new Date("2025-10-13T18:45:00Z"),
    ...
    const clientes = [
        {
            _id: new ObjectId("652a4c7e12f0a7c2d1b7f1a1"),
            nombre: "Carlos",
            correo: "carlos.mendez@gmail.com"
        },
        {
            _id: new ObjectId("652a4c8b52f7d8b2d2c3e2b2"),
            nombre: "María",
            correo: "maria.garcia@gmail.com"
        },
        {
            _id: new ObjectId("652a4c9618e5a6a3f3d4f3c3"),
            nombre: "Jorge",
            correo: "jorge.luna@gmail.com"
        },
        {
            _id: new ObjectId("652a4ca3fae6b7d4a4e5a4d4"),
            nombre: "Sofía",
            correo: "sofia.ramos@gmail.com"
        },
        {
            _id: new ObjectId("652a4cb0cde7c8e5b5f6b5e5"),
            nombre: "Andrés",
            correo: "andres.perez@gmail.com"
        }
    ]
    await obtenerDB().collection("clientes").deleteMany();
    await obtenerDB().collection("clientes").insertMany(clientes);
}
seed();